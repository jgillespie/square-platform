...
namespace App\Modules\Core\Tests\Backend\Settings;
...
class AccountTest extends TestCase
{
    ...
    {
        $response = $this->get(route('backend.settings.account'));
    ...
    /** @test */
    public function enabled_frontend_users_may_not_view_the_account_settings_form()
    {
        $user = $this->make(Account::class, [
            'is_enabled' => true,
            'is_backend' => false,
    ...
    /** @test */
    public function enabled_backend_users_can_view_the_account_settings_form()
    {
        $user = $this->make(Account::class, [
            'is_enabled' => true,
            'is_backend' => true,
        ...
        $response->assertViewIs('core::backend.settings.account');
    }

    /** @test */
    public function guests_may_not_update_the_account_settings()
    {
        $response = $this->patch(route('backend.settings.account'));
    ...
    /** @test */
    public function enabled_frontend_users_may_not_update_the_account_settings()
    {
        $user = $this->make(Account::class, [
            'is_enabled' => true,
            'is_backend' => false,
    ...
    /** @test */
    public function enabled_unverified_backend_users_can_update_the_account_settings()
    {
        $user = $this->make(Account::class, [
            'is_enabled' => true,
            'is_backend' => true,
        ...
        $this->actingAs($user);
        $this->from(route('backend.settings.account'));
        $response = $this->patch(route('backend.settings.account'), [
        ...
        $response->assertRedirect(route('backend.settings.account'));
        $this->assertEquals($newEmail, $user->email);
        $this->assertTrue(Hash::check($newPassword, $user->password));
    }

    /** @test */
    public function enabled_verified_backend_users_can_update_the_account_settings()
    {
        $user = $this->make(Account::class, [
            'is_enabled' => true,
            'is_backend' => true,
