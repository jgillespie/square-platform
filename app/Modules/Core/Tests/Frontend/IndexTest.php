...
namespace App\Modules\Core\Tests\Frontend;
...
class IndexTest extends TestCase
{
    ...
    /** @test */
    public function enabled_backend_users_may_not_access_the_index_page()
    {
        $user = $this->make(Account::class, [
            'is_enabled' => true,
            'is_backend' => true,
    ...
    /** @test */
    public function enabled_frontend_users_can_access_the_index_page()
    {
        $user = $this->make(Account::class, [
            'is_enabled' => true,
            'is_backend' => false,
        ...
        $response->assertViewIs('core::frontend.index');
    }
}
